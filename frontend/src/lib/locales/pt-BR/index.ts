...
export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Orun Notebook não pôde ser alcançado",
    ...
    docLink: "Documentação do Orun Notebook",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Orun Notebook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Orun Notebook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Orun Notebook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {{models}}. O Orun Notebook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Orun Notebook.",
