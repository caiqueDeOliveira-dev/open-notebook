export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Orun Notebook API server could not be reached",
    ...
    docLink: "Orun Notebook Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Orun Notebook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Orun Notebook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Orun Notebook",
    missingRequiredModels: "Missing required models: {{models}}. Orun Notebook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Orun Notebook.",
