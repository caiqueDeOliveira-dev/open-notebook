...
export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Orun Notebook non è raggiungibile",
    ...
    docLink: "Documentazione Orun Notebook",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Orun Notebook di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Orun Notebook.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Orun Notebook",
    missingRequiredModels: "Modelli richiesti mancanti: {{models}}. Orun Notebook potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Orun Notebook.",
