...
export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Orun Notebook недоступен",
    ...
    docLink: "Документация Orun Notebook",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Orun Notebook автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Orun Notebook.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Orun Notebook",
    missingRequiredModels: "Отсутствуют необходимые модели: {{models}}. Orun Notebook может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Orun Notebook.",
